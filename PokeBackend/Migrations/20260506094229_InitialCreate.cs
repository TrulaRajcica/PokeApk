        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CryUrl = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamMemberMoves_Moves_MoveId",
                        column: x => x.MoveId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMemberMoves_MoveId",
                table: "TeamMemberMoves",
                column: "MoveId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamMemberMoves_TeamMemberId",
                table: "TeamMemberMoves",
                column: "TeamMemberId");
